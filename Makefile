...
SRC = src/main.c src/app.c src/canvas.c src/image_io.c src/layers.c src/layer_name_shortcuts.c
OBJ = $(SRC:.c=.o)
BIN = openshop
...
SHORTCUT_TEST_SRC = tests/shortcut_selftest.c src/layer_name_shortcuts.c
