...
SHORTCUT_TEST_SRC = tests/shortcut_selftest.c src/app_brush.c src/app_brush_mask.c src/app_color.c src/app_layer_state.c src/app_preview.c src/app_sampled_color.c src/app_shape.c src/app_shape_cancel.c src/app_title.c src/canvas.c src/layer_name_shortcuts.c src/direct_layer_shortcuts.c src/history_shortcuts.c src/file_shortcuts.c src/merge_shortcuts.c src/paint_shortcuts.c src/brush_shortcuts.c src/view_shortcuts.c src/canvas_shortcuts.c
