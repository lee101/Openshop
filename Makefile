...
LAYER_STACK_TEST_BIN = app_layer_stack_smoke
LAYER_STACK_TEST_SRC = tests/app_layer_stack_smoke.c src/app_layer_stack.c src/canvas.c src/layers.c
NAVIGATION_TEST_BIN = app_navigation_smoke
NAVIGATION_TEST_SRC = tests/app_navigation_smoke.c src/app_navigation.c src/canvas.c src/layers.c
...
TRANSLATION_TEST_SRC = tests/app_translation_smoke.c src/app_translation.c src/canvas.c src/layers.c
TOOL_TEST_BIN = app_tool_smoke
TOOL_TEST_SRC = tests/app_tool_smoke.c src/app_tool.c src/canvas.c src/layers.c
...
$(LAYER_STACK_TEST_BIN): $(LAYER_STACK_TEST_SRC)
	$(CC) -std=c11 -O2 -Wall -Wextra $(LAYER_STACK_TEST_SRC) -o $(LAYER_STACK_TEST_BIN) -lm
