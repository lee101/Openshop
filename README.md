...
- `Ctrl+Alt+1` ... `Ctrl+Alt+8`: select the 1st-8th visible layer
- `Ctrl+Alt+Shift+1` ... `Ctrl+Alt+Shift+8`: select the 1st-8th unlocked layer
...
- `Ctrl+Home / Ctrl+End`: send active layer to bottom/top
...
- `Ctrl+Shift+H`: hide the active layer and jump to the next visible unlocked layer when possible
- `Ctrl+Shift+L`: toggle active layer lock
- `Ctrl+Shift+K`: lock or unlock all non-active layers
- `Ctrl+Shift+I`: hide or restore all non-active layers
- `Ctrl+Shift+U`: unlock all layers
