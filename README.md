...
- Failed edits, unchanged edits, failed internal snapshot capture/compare steps, and failed undo/redo step applications all preserve the existing undo/redo stacks and their retained snapshots.
