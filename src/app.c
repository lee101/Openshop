        ...
        while (SDL_PollEvent(&e)) {
            ...
            case SDL_KEYDOWN: {
                ...
                if (key == SDLK_b) {
                    ...
                    if (apply_canvas_transform(&layers, undo_stack, &undo_count, redo_stack, &redo_count, canvas_blur)) {
                        needs_composite = 1;
                    }
                } else if (key == SDLK_f) {
                    int mx = 0;
